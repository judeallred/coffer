...
export function force1Of2Restriction(
...
export function wrappedDelegatedPuzzleHash(
...
export class Clvm {
  ...
  spendMedievalVault(
    medievalVault: MedievalVault,
    usedPubkeys: PublicKey[],
    conditions: Program[],
    genesisChallenge: Uint8Array,
  ): void;
  spendMedievalVaultUnsafe(
    medievalVault: MedievalVault,
    usedPubkeys: PublicKey[],
    delegatedSpend: Spend,
  ): void;
  medievalVaultRekeyDelegatedPuzzle(
    launcherId: Uint8Array,
    newM: usize,
    newPubkeys: PublicKey[],
    coinId: Uint8Array,
    genesisChallenge: Uint8Array,
  ): Program;
  medievalVaultSendMessageDelegatedPuzzle(
    message: Uint8Array,
    receiverLauncherId: Uint8Array,
    myCoin: Coin,
    myInfo: MedievalVaultInfo,
    genesisChallenge: Uint8Array,
  ): Program;
  rewardDistributorFromSpend(
    spend: CoinSpend,
    reserveLineageProof: LineageProof | undefined,
    constants: RewardDistributorConstants,
  ): RewardDistributor | undefined;
  rewardDistributorFromParentSpend(
    parentSpend: CoinSpend,
    constants: RewardDistributorConstants,
  ): RewardDistributor | undefined;
  rewardDistributorFromEveCoinSpend(
    constants: RewardDistributorConstants,
    initialState: RewardDistributorState,
    eveCoinSpend: CoinSpend,
    reserveParentId: Uint8Array,
    reserveLineageProof: LineageProof,
  ): RewardDistributorInfoFromEveCoin | undefined;
  launchRewardDistributor(
    offer: SpendBundle,
    firstEpochStart: bigint,
    catRefundPuzzleHash: Uint8Array,
    constants: RewardDistributorConstants,
    mainnet: boolean,
    comment: string,
  ): RewardDistributorLaunchResult;
  createOfferSecurityCoin(offer: SpendBundle): OfferSecurityCoinDetails;
  spendOfferSecurityCoin(
    securityCoinDetails: OfferSecurityCoinDetails,
    conditions: Program[],
    mainnet: boolean,
  ): Signature;
  spendSettlementNft(
    ...
    nonce: Uint8Array,
    destinationPuzzleHash: Uint8Array,
...
export class CoinsetClient {
  ...
  ): Promise<GetCoinRecordsResponse>;
...
export class MipsSpend {
  ...
  singletonMember(
    config: MemberConfig,
    launcherId: Uint8Array,
    singletonInnerPuzzleHash: Uint8Array,
    singletonAmount: bigint,
  ): void;
  ...
  force1Of2RestrictedVariable(
    ...
    memberValidatorListHash: Uint8Array,
    delegatedPuzzleValidatorListHash: Uint8Array,
    newRightSideMemberHash: Uint8Array,
  ): void;
...
export class RestrictionMemo {
  ...
  puzzleHash: Uint8Array;
  memo: Program;
  static force1Of2RestrictedVariable(
    clvm: Clvm,
    leftSideSubtreeHash: Uint8Array,
    nonce: number,
    memberValidatorListHash: Uint8Array,
...
export class Program {
  ...
  parseRewardDistributorLauncherSolution(
    launcherCoin: Coin,
  ): RewardDistributorLauncherSolutionInfo | undefined;
}
export class Puzzle {
  free(): void;
  __getClassname(): string;
...
export class RewardDistributor {
  ...
  static reserveFullPuzzleHash(
    assetId: Uint8Array,
    distributorLauncherId: Uint8Array,
    nonce: bigint,
  ): Uint8Array;
  static parseLauncherSolution(
    launcherCoin: Coin,
    launcherSolution: Program,
  ): RewardDistributorInfoFromLauncher | undefined;
  ...
  withdrawIncentives(
    ...
    rewardSlot: RewardSlot,
  ): RewardDistributorWithdrawIncentivesResult;
  addEntry(
    payoutPuzzleHash: Uint8Array,
    shares: bigint,
  ...
  removeEntry(
    entrySlot: EntrySlot,
    managerSingletonInnerPuzzleHash: Uint8Array,
  ): RewardDistributorRemoveEntryResult;
  stake(
    currentNft: Nft,
    nftLauncherProof: NftLauncherProof,
    entryCustodyPuzzleHash: Uint8Array,
  ): RewardDistributorStakeResult;
  unstake(entrySlot: EntrySlot, lockedNft: Nft): RewardDistributorUnstakeResult;
  static lockedNftHint(
    distributorLauncherId: Uint8Array,
    custodyPuzzleHash: Uint8Array,
  ): Uint8Array;
}
